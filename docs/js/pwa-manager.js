// PWA Installation and Management Script for Docs Site
class PWAManager {
  constructor() {
  ...
  async registerServiceWorker() {
    if ('serviceWorker' in navigator) {
      try {
        const registration = await navigator.serviceWorker.register('/youtube-music/sw.js', {
          scope: '/youtube-music/'
        });
  ...
  showInstalledMessage() {
    this.showToast('✅ YouTube Music docs installed successfully!', 'success');
  }
  ...
  showNotification(title, options = {}) {
    if ('Notification' in window && Notification.permission === 'granted') {
      const notification = new Notification(title, {
        icon: 'favicon/favicon_144.png',
        badge: 'favicon/favicon_32.png',
        ...options
      });
