...
// main class
module.exports.VolumeFader = class VolumeFader {
    /**
    ...
    constructor(media, options) {
        ...
        // no linear, but logarithmic fading…
            ...
            options.fadeScaling &&
                this.logger &&
                this.logger(
                    `Using logarithmic fading with ${String(
                        10 * dynamicRange,
                    )} dB dynamic range.`,
                );
        }
    ...
    updateVolume() {
        ...
        if (this.active && this.fade) {
            ...
            if (now < this.fade.time.end) {
                ...
                this.media.volume = this.scale.internalToVolume(
                ...
                typeof this.fade.callback === 'function' &&
                    this.fade.callback();
