        ...
        ? [
              {
                  ...
                  click: (item) =>
                      config.setAndMaybeRestart('interactive', item.checked),
              },
              {
                  ...
                  submenu: [
                      {
                          ...
                          click: (item) =>
                              config.set('trayControls', item.checked),
                      },
                      {
                          ...
                          click: (item) =>
                              config.set('hideButtonText', item.checked),
                      },
                      {
                          ...
                          click: (item) =>
                              config.set('refreshOnPlayPause', item.checked),
                      },
                  ],
              },
              {
