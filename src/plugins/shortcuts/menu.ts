    ...
    const output = await prompt(
      {
        ...
        keybindOptions: [
          ...
          kb(
            t('plugins.shortcuts.prompt.keybind.keybind-options.go-back'),
            'goBack',
            config.global?.goBack,
          ),
          kb(
            t('plugins.shortcuts.prompt.keybind.keybind-options.go-forward'),
            'goForward',
            config.global?.goForward,
          ),
          kb(
